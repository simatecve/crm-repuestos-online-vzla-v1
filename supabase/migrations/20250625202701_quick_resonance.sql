/*
  # WhatsApp Instances and Webhooks Management

  1. New Tables
    - `whatsapp_webhooks` - Store webhook URLs for WhatsApp integration
    - `whatsapp_instances` - Store WhatsApp instance configurations
